...
public class EmployeeTest {
    ...
    void createEmployee() {
        Employee employee = new Employee(1L, "조현수", "개발팀", 80000, LocalDate.of(2020, 1, 1));
    ...
    void employeeEquality() {
        Employee employee1 = new Employee(1L, "조현수", "개발팀", 80000, LocalDate.of(2020, 1, 1));
        Employee employee2 = new Employee(1L, "이은미", "디자인팀", 75000, LocalDate.of(2021, 1, 1));
